...
function req({url, method, params, data, domain, cookies, spider = false, platform = 'tx'}) {
    ...
    return new Promise(function (resolve, reject) {
        superagent(method, url)
            ...
            .set('Sec-Ch-Dpr', '0.9')
            .set('Sec-Ch-Ua', '"Chromium";v="118", "Google Chrome";v="118", "Not=A?Brand";v="99"')
            .set('Sec-Ch-Ua-Mobile', '?0')
            .set('Sec-Ch-Ua-Platform', 'Windows')
            .set('Sec-Ch-Ua-Platform-Version', '7.0.0')
            .set('Sec-Ch-Viewport-Width', '1038')
            .set('Sec-Fetch-Dest', 'document')
            .set('Sec-Fetch-Mode', 'navigate')
            .set('Sec-Fetch-Site', 'same-origin')
            .set('Sec-Fetch-User', '?1')
            .set('Upgrade-Insecure-Requests', '1')
            .set('User-Agent', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/118.0.0.0 Safari/537.36')
            .set('Viewport-Width', '1038')
            .set('Cookie',cookie)
